...
function Library.Load(o)
	...
	Background_1.BackgroundColor3 = Color3.fromRGB(25, 20, 40)
	...
	UIGradient_1.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(25, 20, 40)), ColorSequenceKeypoint.new(0.5, Color), ColorSequenceKeypoint.new(1, Color3.fromRGB(25, 20, 40))}
	UIGradient_1.Transparency = NumberSequence.new{NumberSequenceKeypoint.new(0,0), NumberSequenceKeypoint.new(0.5,0.02), NumberSequenceKeypoint.new(1,0)}
	...
	Shadow_BG.Size = UDim2.new(1.05, 0,1.05, 0)
	...
	TItleIcon_1.Size = UDim2.new(0, 100,0, 25)
	...
	Keybox_1.BackgroundColor3 = Color3.fromRGB(35, 30, 55)
	...
	Shadow_1.Size = UDim2.new(1.05, 0,1.1, 0)
	...
	Shadow_2.Size = UDim2.new(1.05, 0,1.1, 0)
	...
	task.spawn(function()
		...
		tw({v = Background_1, t = 0.5, s = Enum.EasingStyle.Quad, d = "Out", g = {BackgroundTransparency = 0.1}}):Play()
				...
				task.delay(0.05, function()
					...
					task.delay(0.05, function()
						...
						task.delay(0.05, function()
							...
							tw({v = UIStroke_1, t = 0.3, s = Enum.EasingStyle.Quad, d = "Out", g = {Transparency = 0.5}}):Play()
	...
	if Click_2 then
		Click_2.MouseButton1Click:Connect(function()
			tw({v = Button_2, t = 0.1, s = Enum.EasingStyle.Quad, d = "InOut", g = {Size = UDim2.new(1, 0,0, 32), BackgroundColor3 = Color3.fromRGB(100, 220, 100)}}):Play()
			task.delay(0.1, function()
	...
	if Click_1 then
		Click_1.MouseButton1Click:Connect(function()
			...
			tw({v = Button_1, t = 0.1, s = Enum.EasingStyle.Quad, d = "InOut", g = {Size = UDim2.new(1, 0,0, 32), BackgroundColor3 = Color3.fromRGB(255, 193, 7)}}):Play()
			...
			task.delay(0.5, function()
				...
				if found then
					...
					task.delay(0.5, function()
						tw({v = Button_1, t = 0.2, s = Enum.EasingStyle.Quad, d = "InOut", g = {BackgroundColor3 = Color, Size = UDim2.new(1, 0,0, 35)}}):Play()
						checkingKey = false
					end)
				end
			end)
