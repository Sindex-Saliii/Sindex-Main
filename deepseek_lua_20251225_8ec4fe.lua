...
function Library.Load(o)
	...
	local BackgroundGroup = Instance.new("Frame")
	BackgroundGroup.Name = "BackgroundGroup"
	BackgroundGroup.Parent = ScreenGui
	BackgroundGroup.BackgroundTransparency = 1
	BackgroundGroup.Size = UDim2.new(1, 0, 1, 0)
